...
#Lo metrics to a file
with autopilot("mnist_cnn", tags=["keras", "mnist", "cnn"]) as tracker:
    history = model.fit(
        x_train, y_train,
...
from visualiser import visualise_metrics

# After training, just run:
visualise_metrics("blackbox_logs/metrics_20250420_134513.json")

# After training blocks
import os
import glob

# Get latest metrics log file
